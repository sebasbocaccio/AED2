...
class Conjunto
{
    public:
        ...
        //Funcion axuliar para conseguir siguiente
    ...
    private:
        ...
        struct Nodo
        {
            ...
            Nodo(const T& v): valor(v),padre(NULL),izq(NULL),der(NULL){}
        ...
        void borradorNodo(Nodo* nodo);
        void siguienteBusqueda(const T &clave,int cant, Nodo* nodo, T &valorSig );
